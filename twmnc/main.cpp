...
int main(int argc, char** argv)
{
    ...
    desc.add_options()
            ...
            ("position,pos", po::value<std::string>(), "Position of this notification. Either top_right, top_left, bottom_right or bottom_left.")
            ("font,fn", po::value<std::string>(), "The font to use for this notification.")
            ("font-size,fs", po::value<std::string>(), "The font size for this notification.")
            ("duration,d", po::value<int>(), "How long this notification remains visible")
            ("sound-command,sc", po::value<std::string>(), "A command to play a specific sound for this notification")
            ("background,bg", po::value<std::string>(), "The background color")
            ("foregroun,fg", po::value<std::string>(), "The foreground color, which is the font color.")
            ("id", po::value<int>(), "A message id. You should have given an id to the first message in order to modify it")
            ("always-on-top,aot", "Always on top. Specially on fullscreen applications, default.")
            ("activated-command,ac", po::value<std::string>(), "A command to run when the notification is activated.")
